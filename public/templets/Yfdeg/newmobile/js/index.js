$(function(){
	...
	$(".right_box ul li a").click(function () {
		$(".right_box ul li a").removeClass("on");
		$(this).addClass('on');
	});
	...
	/* $("#focus .tempWrap li").each(function(){
			$(this).append('<img src="http://www.91chuangye.com/images/defaultpic.gif">');
		}); */
	...
	$('.xm_info_top .right').click(function(){
		var sTop=$('.item_zx').offset().top-100;
