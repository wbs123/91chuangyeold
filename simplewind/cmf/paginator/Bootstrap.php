...
class Bootstrap extends Paginator
{
    ...
    protected function getLinks()
    {
  	...
  	public function getCountRowCountPage(){
        return '<li><span class="pageinfo">共 <strong>'.$this->lastPage().'</strong>页<strong>'.$this->total().'</strong>条</span></li>';
